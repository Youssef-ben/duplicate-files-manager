  ...
  return (
    ...
    >
      ...
      <div className="text-center flex flex-col gap-1.5">
        <h2 className="text-xl font-semibold text-on-surface">Synchronization Completed</h2>
        <p className="hidden text-sm max-w-xs text-on-surface-variant">
          All files have been synchronized.
        </p>
        <p className="text-sm max-w-xs text-on-surface-variant">
          You can now proceed to the next step or refresh at any time to synchronize again.
        </p>
      </div>
      <button
      ...
      >
        ...
        <span className="text-sm group-hover:font-normal">
          Re-scan for more files to synchronize
        </span>
      </button>
    </div>
  );
