...
const IdleContent = (): React.JSX.Element => {
  return <div>Choose a root directory to begin the duplicates finder process.</div>
}

const RunningContent = (): React.JSX.Element => {
  return <div>Scanning directory structure to prepare for duplicates search.</div>
}
