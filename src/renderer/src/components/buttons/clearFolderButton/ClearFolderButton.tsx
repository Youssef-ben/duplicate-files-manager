  ...
  return (
    <button
      ...
      className={mergeCls(
        ...
        'group active:scale-95 cursor-pointer border border-primary bg-transparent text-on-primary hover:bg-primary-dim/80 hover:text-on-primary hover:border-primary-dim'
      )}
    >
