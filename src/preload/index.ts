...
contextBridge.exposeInMainWorld('api', {
  openFolder: (): Promise<string | null> => ipcRenderer.invoke(CH.DIALOG_OPEN_FOLDER),

  cliRun: (args: CliRunArgs): void => ipcRenderer.send(CH.CLI_RUN, args),

  cliCancel: (runId: string): void => ipcRenderer.send(CH.CLI_CANCEL, runId),
